...
If you have git installed:
  ...
  script/plugin install git://github.com/pivotal/desert.git

If you do not have git installed

* Go to http://github.com/pivotal/desert/tree/master
* Click download tarball
* Untar and expand the file to vendor/plugins/desert
...
3. Install your desert plugin routes in routes.rb
